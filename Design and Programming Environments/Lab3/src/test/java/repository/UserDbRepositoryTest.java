...
public class UserDbRepositoryTest {
    ...
    public void getLogin() {
        assertFalse(repo.getLogin("user1","12345"));
        assertTrue(repo.getLogin("user1","123456"));
        assertTrue(repo.getLogin("user2","123456789"));
        assertTrue(repo.getLogin("user3","password"));
        assertFalse(repo.getLogin("user5","wrong_password"));
    }
