...
public class ChatClientRpcReflectionWorker implements Runnable, IObserver {
    ...
    @Override
    public void enitityAdded(TableEntity entity) throws ValidationException {

    }

    @Override
    public void personLoggedIn(User user) throws ValidationException {

    }

    @Override
    public void personLoggedOut(User user) throws ValidationException {
