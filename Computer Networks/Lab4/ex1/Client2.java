...
public class Client2
{
  ...
  private static void writeIntegersToSocket (int a, int b,
  ...
  private static int readUnsignedShort (String message,
    ...
    IOException
  {
    ...
    try
    {
      ...
      if (unsignedShortNumber < UNSIGNED_SHORT_MIN_VALUE
	  || unsignedShortNumber > UNSIGNED_SHORT_MAX_VALUE)
	{
	  throw new
	    IllegalArgumentException
	    ("The given number must be unsigned short [0..65535]!");
	}
    }
